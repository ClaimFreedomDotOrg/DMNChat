...
const ChatView: React.FC = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-slate-950 text-slate-200 overflow-hidden relative" style={{ height: '100vh' }}>
      {/* Auth Modal */}
      <AuthModal
      ...
      {/* Main Content */}
      <div
        className="flex-1 flex flex-col h-full min-h-0 relative pt-16 sm:pt-0"
